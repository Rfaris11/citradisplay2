...
<body>
<?php $this->load->view("komponen/navbar.php"); ?>

<!-- START : CAROUSEL -->
<div class="row" style="padding: 70px 30px 30px 30px; /* min-height:100%; height:100%; overflow: hidden; */ display: flex; align-items: center; position: relative;">
