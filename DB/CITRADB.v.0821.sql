...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Agu 2017 pada 15.31
...
--
-- Struktur dari tabel `dtl_mst_produk`
--
...
--
-- Struktur untuk view `v_detail_produk`
--
...
--
ALTER TABLE `dtl_mst_produk`
  MODIFY `NID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID DETAIL PRODUK';
--
