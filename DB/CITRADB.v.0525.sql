...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2017 at 08:06 AM
...
`NID` int(11) NOT NULL COMMENT 'ID PRODUK',
  `NID_SUBKATEGORI` int(11) NOT NULL COMMENT 'RELASI ID SUB KATEGORI',
...
CREATE TABLE IF NOT EXISTS `MST_SUBKATEGORI` (
`NID` int(11) NOT NULL COMMENT 'ID SUB KATEGORI',
  `NID_KATEGORI` int(11) NOT NULL COMMENT 'RELASI ID KATEGORI',
  `VNAMA` varchar(50) NOT NULL COMMENT 'NAMA SUB KATEGORI',
  `VDESKRIPSI` varchar(100) DEFAULT NULL COMMENT 'DESKRIPSI KATEGORI'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `MST_SUBKATEGORI`
MODIFY `NID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID SUB KATEGORI';
